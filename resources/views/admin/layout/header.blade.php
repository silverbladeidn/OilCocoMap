        ...
        <nav class="app-header navbar navbar-expand bg-body"> <!--begin::Container-->
            <div class="container-fluid"> <!--begin::Start Navbar Links-->
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item d-none d-md-block"> <a href="{{ asset('/') }}" class="nav-link">Beranda</a> </li>
                ...
                <ul class="navbar-nav ms-auto"> <!--begin::Navbar Search-->
                    ...
                    <li class="nav-item dropdown"> <a class="nav-link" data-bs-toggle="dropdown" href="#"> <i class="bi bi-chat-text"></i> <span class="navbar-badge badge text-bg-danger">3</span> </a>
                        <div class="dropdown-menu dropdown-menu-lg dropdown-menu-end"> <a href="#" class="dropdown-item"> <!--begin::Message-->
                                <div class="d-flex">
                                    <div class="flex-shrink-0"> <img src="<?php echo asset('assets/admin') ?>/dist/assets/img/user1-128x128.jpg" alt="User Avatar" class="img-size-50 rounded-circle me-3"> </div>
                            ...
                            <div class="dropdown-divider"></div> <a href="#" class="dropdown-item"> <!--begin::Message-->
                                <div class="d-flex">
                                    <div class="flex-shrink-0"> <img src="<?php echo asset('assets/admin') ?>/dist/assets/img/user8-128x128.jpg" alt="User Avatar" class="img-size-50 rounded-circle me-3"> </div>
                                    <div class="flex-grow-1">
                                        <h3 class="dropdown-item-title">
                                            John Pierce
                            ...
                            <div class="dropdown-divider"></div> <a href="#" class="dropdown-item"> <!--begin::Message-->
                                <div class="d-flex">
                                    <div class="flex-shrink-0"> <img src="<?php echo asset('assets/admin') ?>/dist/assets/img/user3-128x128.jpg" alt="User Avatar" class="img-size-50 rounded-circle me-3"> </div>
                                    <div class="flex-grow-1">
                                        <h3 class="dropdown-item-title">
                                            Nora Silvester
                    ...
                    <li class="nav-item dropdown user-menu"> 
                        <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown"> 
                            <img src="<?php echo asset('assets/admin') ?>/dist/assets/img/user2-160x160.jpg" class="user-image rounded-circle shadow" alt="User Image"> 
                        ...
                        <ul class="dropdown-menu dropdown-menu-lg dropdown-menu-end"> 
                            ...
                            <li class="user-header text-bg-primary"> 
                                <img src="<?php echo asset('assets/admin') ?>/dist/assets/img/user2-160x160.jpg" class="rounded-circle shadow" alt="User Image">
                                <p>
                                    <?php echo Session()->get('nama') ?> - <?php echo Session()->get('akses_level') ?>
                                    <small>Status: <?php echo Session()->get('status_user') ?></small>
                                </p>
                            ...
                            <li class="user-footer"> 
                                <a href="{{ asset('admin/akun') }}" class="btn btn-default btn-flat">Profile</a> 
                                <a href="{{ asset('logout') }}" class="btn btn-default btn-flat float-end">Logout</a> 
                            </li> <!--end::Menu Footer-->
                        </ul>
