...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('assets/admin/dist/css/adminlte.css') }}"><!--end::Required Plugin(AdminLTE)-->
    <!-- jQuery UI CSS -->
    ...
    <script src="{{ asset('assets/sweetalert/sweetalert2.all.min.js') }}" type="text/javascript"></script>
    <!-- leafletjs -->
